...
import cz.hlavja.config.audit.AuditEventConverter;
import cz.hlavja.domain.PersistentAuditEvent;
...
import static cz.hlavja.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
