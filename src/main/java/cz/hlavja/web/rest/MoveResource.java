...
/**
 * REST controller for managing {@link cz.hlavja.domain.Move}.
 */
@RestController
@RequestMapping("/api")
public class MoveResource {
    ...
    public ResponseEntity<MoveDTO> updateMove(@RequestBody MoveDTO moveDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, moveDTO.getId().toString()))
            .body(result);
    }
